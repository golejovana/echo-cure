...
const SR: Translations = {
  ...
  anamnesis: "ANAMNEZA I STATUS PRAESENS",
  workingDiagnoses: "Radne dijagnoze",
  chiefComplaints: "Glavne tegobe",
  presentIllness: "Sadašnja bolest",
  clinicalTimeline: "Klinička hronologija",
  systemAnamnesis: "ANAMNEZA PO SISTEMIMA",
  personalHistory: "LIČNA ANAMNEZA",
  allergies: "Alergije (LA)",
  chronicDiseases: "Hronične bolesti",
  surgeries: "Hirurške intervencije",
  regularTherapy: "Redovna terapija",
  familyHistory: "PORODIČNA ANAMNEZA",
  socioEpidemiological: "SOCIO-EPIDEMIOLOŠKA ANAMNEZA",
  livingConditions: "Uslovi života",
  smokingAlcohol: "Pušenje / Alkohol",
  epidemiological: "Epidemiološki podaci",
  statusPraesens: "STATUS PRAESENS — OBJEKTIVNI NALAZ",
  stampLabel: "M.P.",
  signatureLabel: "Potpis i faksimil lekara:",
  date: "Datum",
  historyNo: "Br. ist. bolesti:",
  jmbg: "JMBG:",
  address: "Adresa:",
  cardNo: "Br. kartona:",
  cardiovascular: "Kardiovaskularni",
  chestPain: "Bol u grudima",
  swelling: "Otoci",
  pressure: "Pritisak",
  veins: "Vene",
  ...
  urination: "Mokrenje",
  flankPain: "Bol u slabinama",
  locomotor: "Lokomotorni / CNS",
  jointPain: "Bol u zglobovima",
  visionHearing: "Vid / Sluh",
  dizziness: "Vrtoglavica",
  headaches: "Glavobolje",
  bloodPressure: "TA (krvni pritisak)",
  pulse: "Puls",
  temperature: "Temperatura",
  respiration: "Respiracija / SpO₂",
  lungSounds: "Auskultacija pluća",
  heartSounds: "Srčani tonovi",
  abdominalExam: "Pregled abdomena",
  skinExam: "Koža",
  meningealSigns: "Meningealni znaci",
  otherFindings: "Ostali nalazi",
  consent: "OBAVEŠTENA sam o dijagnozi i prognozi bolesti, kratkim opisom, cilju i koristi od predložene medicinske mere, trajanju i mogućim posledicama preduzimanja, odnosno nepreduzimanja predložene medicinske mere, vrsti i verovatnoći mogućih rizika, bolnim i drugim sporednim ili trajnim posledicama, alternativnim metodama lečenja, mogućim promenama stanja posle preduzimanja predložene medicinske mere, kao i mogućnostima nužne promene u načinu života, dejstvu lekova i mogućim sporednim posledicama tog dejstva i PRISTAJEM NA PREDLOŽENU MEDICINSKU MERU, shodno članu 11 i članu 15 Zakona o pravima pacijenata.",
  age: "Godina:",
  occupation: "Zanimanje:",
  socialStatus: "Socijalni status:",
  drug: "Lek:",
  legalNote: "Ovaj dokument je validan uz potpis i pečat ovlašćenog lekara.",
  footerCity: "U",
  footerDay: "dana:",
};
